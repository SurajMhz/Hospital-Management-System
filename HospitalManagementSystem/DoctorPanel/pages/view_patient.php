...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <!-- PATIENT CARD -->
            <div
                style="background:white; border-radius:10px; padding:24px; box-shadow:0 2px 8px rgba(0,0,0,0.1); max-width:600px;">

                <!-- AVATAR + NAME -->
                <div
                    style="display:flex; align-items:center; gap:16px; margin-bottom:24px; padding-bottom:16px; border-bottom:1px solid #eee;">
                    <div
                        style="width:55px; height:55px; border-radius:50%; background:#0B7C75; color:white; display:flex; align-items:center; justify-content:center; font-size:18px; font-weight:bold;">
                    ...
                    <div>
                        ...
                        <div style="font-size:13px; color:#888;"><?= htmlspecialchars($patient['age']) ?> years ·
                ...
                <!-- DETAILS -->
                <table
                    style="width:100%; border-collapse:collapse; font-size:14px; table-layout:fixed; word-wrap:break-word;">
                    ...
                    <tr style="border-bottom:1px solid #f0f0f0;">
                        ...
                        <td style="padding:10px 0; color:#111;"><?= htmlspecialchars($patient['appointment_date']) ?>
                        </td>
                    </tr>
                    <tr style="border-bottom:1px solid #f0f0f0;">
                    ...
                    <tr>
                        ...
                        <td style="padding:10px 0;">
                            <?php if ($patient['source'] === 'Patient Form'): ?>
                                <span
                                    style="background:#dbeafe; color:#1e40af; font-size:12px; padding:3px 10px; border-radius:5px;">Patient
                                    Form</span>
                            <?php else: ?>
                                <span
                                    style="background:#f3f4f6; color:#374151; font-size:12px; padding:3px 10px; border-radius:5px;">Manual</span>
                            <?php endif; ?>
                        </td>
                    </tr>
                </table>
                ...
                <div style="margin-top:24px; padding-top:20px; border-top:2px solid #f0f0f0;">
                    ...
                    <?php if ($prescription): ?>
                        ...
                        <a href="prescription.php?apt_id=<?= $patient['appointment_id'] ?>" style="display:inline-block; margin-top:16px; background:#0B7C75; color:white; padding:8px 16px;
                    ...
                    <?php else: ?>
                        ...
                        <a href="prescription.php?apt_id=<?= $patient['appointment_id'] ?>" style="display:inline-block; margin-top:8px; background:#0B7C75; color:white; padding:8px 16px;
                            border-radius:6px; font-size:13px; text-decoration:none;">
                            + Add Prescription
                        </a>
                    <?php endif; ?>
