...
<section class="hero-section" id="home">
  <div class="hero-overlay">
    <div class="container hero-content text-center text-white">
      ...
      <p class="lead mb-5 hero-sub">Compassionate care, expert doctors, and modern facilities<br>for you and your family — 24 hours a day, 7 days a week.</p>
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-md-6">
        <div class="about-img-wrap">
          ...
          <img src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80"
               alt="Hospital Building" class="img-fluid rounded-4 shadow-lg">
  ...
  <div class="container">
    <div class="row g-4 mb-4">
      ...
      <div class="col-md-4">
        ...
        <p class="text-secondary small">Dedicated to your health and wellbeing since 1995. Serving the community with expert care and modern facilities.</p>
      </div>
